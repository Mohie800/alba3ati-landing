...
const sections = [
  ...
  {
    title: "4. الإعلانات و Google AdMob",
    items: [
      "نستخدم خدمة Google AdMob لعرض الإعلانات داخل التطبيق. AdMob هي خدمة إعلانية مقدمة من Google LLC.",
      "يقوم AdMob بجمع واستخدام معرّف الإعلانات (Advertising ID) الخاص بجهازك لعرض إعلانات ملائمة وقياس أداء الإعلانات.",
      "قد يجمع AdMob بيانات تقنية مثل نوع الجهاز، نظام التشغيل، عنوان IP التقريبي، وبيانات التفاعل مع الإعلانات.",
      "يمكنك إعادة تعيين معرّف الإعلانات أو إلغاء تخصيص الإعلانات من إعدادات جهازك (الإعدادات > الخصوصية > الإعلانات).",
      "لمزيد من المعلومات حول كيفية تعامل Google مع بياناتك، يرجى زيارة سياسة خصوصية Google: https://policies.google.com/privacy",
    ],
  },
  {
  ...
  },
  {
    title: "7. الأطفال",
    items: [
      "لعبة البعاتي مخصصة للأعمار 13 سنة فما فوق.",
      "لا نجمع عن قصد معلومات من الأطفال دون سن 13.",
    ...
    >
      ...
      <section className="relative py-20 px-6 text-center overflow-hidden">
        ...
        >
          ...
          <p className="text-lg opacity-60 mb-2">آخر تحديث: مارس 2026</p>
