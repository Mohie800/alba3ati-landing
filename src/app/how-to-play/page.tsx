...
const roles: {
  ...
  },
  {
    ...
    ability:
      "اختيار القتل كل ليلة أو تحويل لاعب إلى بعاتي — التحويل متاح مرة واحدة فقط طوال اللعبة",
    goal: "دعم فريق البعاتي وتوسيع عددهم حتى السيطرة على القرية",
    tips: [
      "لا تستخدم التحويل مبكراً إلا إذا كنت متأكداً من القيمة الاستراتيجية",
      "اختر هدف التحويل بعناية — لاعب مؤثر يمكن أن يغيّر توازن اللعبة",
      "إذا شكّ الأهالي بوجودك، العب كأنك دور أهالي داعم للقرية",
      "تذكّر: التحويل يُستخدم مرة واحدة فقط طوال اللعبة",
    ],
  },
  {
    name: "العمدة",
  ...
  },
  {
    ...
    tips: [
      ...
      "إذا كنت متأكداً من هوية البعاتي، استخدم الهجوم",
  ...
  },
  {
    ...
    ability:
      "قتل لاعب واحد بضربة سيف لا يمكن صدها — تُستخدم مرة واحدة فقط طوال اللعبة",
  ...
  },
  {
    ...
    goal: "مساعدة القرية في كشف البعاتي باستخدام نتائج التحقيق",
    tips: [
      "اختر لاعبين تشك فيهم — إذا كانوا مختلفين فأحدهما مشبوه",
      "إذا كانا في نفس الفريق وتشك في الاثنين، فكلاهما مشبوه",
      "لا تكشف نتائجك مباشرة — قد يستهدفك البعاتي",
      "حقق مع لاعب موثوق وآخر مشبوه لتأكيد معلوماتك",
    ],
  },
  {
    name: "وَد الزلط",
    team: "الأهالي",
    teamColor: "var(--role-wadalzalat)",
    icon: Droplets,
    ...
    ability:
      "رش لاعب واحد بالماء — إذا كان بعاتي مات، وإلا يموت وَد الزلط نفسه. تُستخدم مرة واحدة فقط طوال اللعبة",
    goal: "استخدام رشة الماء في اللحظة المناسبة للقضاء على بعاتي مؤكد",
    tips: [
      "لا تخاطر برشة الماء إلا إذا كنت شبه متأكد من هوية البعاتي — الخطأ يكلّفك حياتك",
      "انتظر معلومات الكاشف أو جنابو قبل أن ترش أحداً",
      "رشتك تقضي على البعاتي مباشرة، فاستهدف المشتبه به الأقوى",
      "تذكّر: معك رشة واحدة فقط طوال اللعبة!",
    ],
  },
];
...
const gamePhases: {
  ...
  },
  {
    ...
    details: [
      ...
      "الأدوار المتاحة: البعاتي، بعاتي كبير، العمدة، شيخ الدمازين، الكاشف، بله اب سيف، ابو جنزير، جنابو، وَد الزلط",
    ],
  },
  {
    phase: "مرحلة الليل",
    ...
    details: [
      ...
      "جنابو يختار لاعبين للتحقيق",
      "وَد الزلط يرش لاعباً بالماء (إن لم يستخدم رشته بعد)",
  ...
  },
  {
    ...
    details: [
      "فوز البعاتي: عندما يتجاوز عدد البعاتي عدد الأهالي ",
