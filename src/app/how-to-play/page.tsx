...
const roles = [
  {
    ...
    icon: "🗡️",
    description: "القاتل الذي يتخفى بين الأهالي. كل ليلة يختار ضحية للقضاء عليها.",
  ...
  },
  {
    ...
    tips: [
      "لا تكشف هويتك مبكراً وإلا ستصبح هدفاً",
  ...
  },
  {
    ...
    icon: "⚔️",
    description: "المحارب الشجاع. يمكنه إما القضاء على مشبوه أو حماية الجميع لليلة واحدة.",
    ability: "قدرة خاصة تُستخدم مرة واحدة فقط طوال اللعبة: إما قتل لاعب أو حماية الجميع",
  ...
  },
  {
    ...
    icon: "⛓️",
    description: "الذئب الوحيد. يلعب لوحده ضد الجميع. يفوز عندما يكون آخر من يبقى.",
...
const gamePhases = [
  {
    ...
    description: "يقوم أحد اللاعبين بإنشاء غرفة (خاصة بكود أو عامة) ثم ينضم باقي اللاعبين.",
    details: [
  ...
  },
  {
    ...
    details: [
      ...
      "الأدوار المتاحة: البعاتي، العمدة، شيخ الدمازين، ست الودع، ابو جنزير",
    ],
  },
  {
    phase: "مرحلة الليل",
  ...
  },
  {
    ...
    icon: "☀️",
    color: "var(--role-al3omda)",
    description: "اللاعبون يتناقشون عبر المحادثة الصوتية المباشرة لتحديد المشتبه بهم.",
    details: [
  ...
  },
  {
    ...
    details: [
      ...
      "بعد التصويت، يُكشف دور اللاعب المطرود",
    ],
  },
  {
    phase: "شروط الفوز",
    ...
    description: "اللعبة تستمر بتكرار الليل والنهار حتى يتحقق شرط فوز أحد الفرق.",
    details: [
...
const tips = [
  {
    icon: "🧠",
    title: "راقب وحلّل",
    description: "انتبه لسلوك اللاعبين وردود أفعالهم. من يتهم من؟ من يدافع عن من؟ هذه الأنماط تكشف الكثير.",
  },
  {
    icon: "🤫",
    title: "لا تكشف أوراقك",
    description: "إذا كان لديك دور خاص، لا تكشف هويتك مبكراً. المعلومات قوة — استخدمها بحكمة.",
  },
  {
    icon: "🎭",
    title: "أتقن التمثيل",
    description: "سواء كنت بعاتي أو أهالي، تعلم كيف تتحكم في لغة جسدك ونبرة صوتك أثناء النقاش.",
  },
  {
    icon: "🤝",
    title: "ابنِ تحالفات",
    description: "التعاون مع لاعبين تثق بهم يزيد فرصك في البقاء. لكن كن حذراً — قد يكون حليفك هو البعاتي!",
  },
  {
    icon: "📊",
    title: "تتبع المعلومات",
    description: "حاول تذكر تصويتات اللاعبين ومواقفهم في كل جولة. الأنماط المتكررة تساعد في كشف الأدوار.",
  },
  {
    icon: "🎯",
    title: "اختر معاركك",
    description: "لا تتهم كل من يختلف معك. ركّز على الأدلة الحقيقية وقدّم حججاً مقنعة عند التصويت.",
  },
];
...
export default function HowToPlayPage() {
  return (
    ...
    >
      ...
      <section className="relative py-20 px-6 text-center overflow-hidden">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-base opacity-70 leading-relaxed">
            البعاتي لعبة اجتماعية سودانية مستوحاة من ألعاب الأدوار الخفية. تتطلب الذكاء والخداع والمراقبة. تعرّف على قواعد اللعبة وأدوار اللاعبين واستراتيجيات الفوز.
          </p>
        </motion.div>
      </section>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg leading-relaxed mb-6" style={{ color: "rgba(255,255,255,0.9)" }}>
              البعاتي لعبة جماعية سودانية تجمع بين ٥ إلى ١٥ لاعباً. يتم توزيع أدوار سرية على اللاعبين:
              بعضهم &quot;بعاتي&quot; (أشرار) وبعضهم &quot;أهالي&quot; (أبرياء) مع أدوار خاصة. اللعبة تدور بين
              مرحلتي الليل والنهار — في الليل ينفذ كل دور قدرته السرية، وفي النهار يتناقش الجميع
              عبر المحادثة الصوتية ويصوتون لطرد المشتبه بهم.
            </p>
      ...
      <section id="phases" className="max-w-4xl mx-auto px-6 pb-16 scroll-mt-20">
        <motion.div
            ...
            >
              ...
              <div className="absolute top-3 left-3 opacity-10">
                <svg width="20" height="20" viewBox="0 0 20 20">
                  <polygon points="10,1 18,5 18,15 10,19 2,15 2,5" fill="none" stroke={phase.color} strokeWidth="1" />
                </svg>
              </div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <h3
                    ...
                    style={{ fontFamily: "var(--font-reem-kufi)", color: phase.color }}
                  >
                    {phase.phase}
                  </h3>
                </div>
                  ...
                  >
                    <span className="mt-1.5 shrink-0">
                      <svg width="10" height="10" viewBox="0 0 10 10">
                        <polygon points="5,0 10,5 5,10 0,5" fill={phase.color} opacity="0.5" />
                      </svg>
                    </span>
                    <span>{detail}</span>
                  </li>
      ...
      <section id="roles" className="max-w-4xl mx-auto px-6 py-16 scroll-mt-20">
        ...
        >
          ...
          <p className="mt-4 opacity-60 max-w-xl mx-auto">
            كل دور في البعاتي له قدرات وأهداف مختلفة. تعرّف على كل دور وكيف تلعبه بذكاء.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          {[
            { team: "الأهالي", color: "var(--role-al3omda)", icon: "🏘️", desc: "هدفهم كشف البعاتي وحماية القرية" },
            { team: "البعاتي", color: "var(--role-ba3ati)", icon: "🗡️", desc: "هدفهم القضاء على الأهالي دون انكشاف" },
            { team: "ابو جنزير", color: "var(--role-abujanzeer)", icon: "⛓️", desc: "يلعب وحده ويفوز بالبقاء الأخير" },
          ].map((t, i) => (
            <motion.div
              key={i}
              custom={i}
            ...
            >
              ...
              <h3 className="font-bold text-lg mb-1" style={{ color: t.color, fontFamily: "var(--font-reem-kufi)" }}>
                فريق {t.team}
              </h3>
          ...
          {roles.map((role, idx) => (
            ...
            >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3
                      ...
                      style={{ fontFamily: "var(--font-reem-kufi)", color: role.teamColor }}
                    >
                      {role.name}
                    </h3>
                    <span
                      className="text-xs font-bold px-2 py-0.5 rounded-full"
                      style={{ background: `${role.teamColor}25`, color: role.teamColor }}
                    >
                      فريق {role.team}
                    </span>
                  </div>
              ...
              <div className="p-6 pt-2 space-y-4">
                <p className="leading-relaxed" style={{ color: "var(--sand)", opacity: 0.85 }}>
                  {role.description}
                </p>
                ...
                <div
                  ...
                  style={{ background: `${role.teamColor}10`, border: `1px solid ${role.teamColor}15` }}
                >
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm">⚡</span>
                    <span className="font-bold text-sm" style={{ color: role.teamColor }}>القدرة الليلية</span>
                  </div>
                  <p className="text-sm" style={{ color: "var(--sand)", opacity: 0.8 }}>{role.ability}</p>
                </div>

                {/* Goal */}
                <div
                  className="rounded-xl p-4"
                  style={{ background: "rgba(232,213,183,0.05)", border: "1px solid rgba(232,213,183,0.1)" }}
                >
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm">🎯</span>
                    <span className="font-bold text-sm" style={{ color: "var(--sand)" }}>الهدف</span>
                  </div>
                  <p className="text-sm" style={{ color: "var(--sand)", opacity: 0.8 }}>{role.goal}</p>
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-sm">💡</span>
                    <span className="font-bold text-sm" style={{ color: "var(--sand)" }}>نصائح اللعب</span>
                  </div>
                      ...
                      >
                        <span className="mt-1.5 shrink-0">
                          <svg width="8" height="8" viewBox="0 0 8 8">
                            <polygon points="4,0 8,4 4,8 0,4" fill={role.teamColor} opacity="0.5" />
                          </svg>
                        </span>
                        <span>{tip}</span>
                      </li>
            ...
            >
              <div className="absolute top-3 left-3 opacity-10">
                <svg width="16" height="16" viewBox="0 0 16 16">
                  <polygon points="8,0 16,8 8,16 0,8" fill="none" stroke="var(--terracotta)" strokeWidth="1" />
                </svg>
              </div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--sand)", opacity: 0.75 }}>
                {tip.description}
              </p>
            </motion.div>
          ))}
